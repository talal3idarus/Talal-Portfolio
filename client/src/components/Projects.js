...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute top-32 left-16 w-20 h-20 bg-accent-orange/10 rounded-2xl animate-float rotate-12"></div>
      <div className="absolute bottom-40 right-20 w-16 h-16 bg-primary/10 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
      <div className="absolute top-1/2 left-8 w-12 h-12 bg-accent-gold/10 rounded-lg animate-float rotate-45" style={{animationDelay: '2s'}}></div>
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-16 animate-fadeInUp">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="gradient-text">Projects & Innovation</span>
          </h2>
          <p className="text-xl text-text-muted max-w-3xl mx-auto leading-relaxed">
            From award-winning research to impactful applications — 
            explore the projects where{' '}
            <span className="text-primary font-semibold">technology</span> meets{' '}
            ...
            <button
              ...
              className={`category-filter-btn ${
                selectedCategory === category 
                  ? 'bg-gradient-accent text-white shadow-warm' 
                  : 'bg-surface-glass border-2 border-border text-text-muted hover:border-accent-orange hover:text-accent-orange'
              }`}
            >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="card glass h-full overflow-hidden hover-float">
                {/* Project Image */}
                <div className="relative overflow-hidden rounded-lg mb-6">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end justify-between p-4 transition-opacity duration-300 ${
                    ...
                    {project.featured && (
                      <div className="bg-accent-gold/90 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-medium text-white">
                        ⭐ Featured
                      </div>
                    )}
                  </div>
